...
function setup()
  return {
    properties = {
      max_speed_for_map_matching      = 60/3.6, -- 180kmph -> m/s
    ...
    classes = Sequence {
        'toll', 'motorway', 'restricted', 'tunnel'
    },
    ...
    surface_speeds = {
      asphalt = 30,    -- nil mean no limit. removing the line has the same effect
      concrete = 30,
      ["concrete:plates"] = nil,
      ["concrete:lanes"] = nil,
      paved = 30,
...
function process_turn(profile, turn)
  ...
  if turn.number_of_roads > 2 or turn.is_u_turn then
